...
export default class PersonalizarDir extends Component {
  ...
  guardarDir = () => {
    ...
    if (
      ...
      fetch(
        GLOBALS.BASE_URL + 'api/api.php?type=insertar&que=direccion&token=b8d356e2b7134759f486a167583c7e9e',
        {
          method: 'POST',
          headers: {
        ...
        .then((responseJson) => {
          ...
          if (responseJson.status == 'ERROR') {
            ...
            AsyncStorage.setItem(
              'direcciones',
              JSON.stringify(this.state.direcciones),
            );
            this.props.navigation.replace('Carrito');
          }
        })
    ...
    if (this.state.isLoading) {
      return (
        <View
          ...
          <Image
            source={require('@recursos/images/loader.gif')}
    ...
    return (
      <View
        ...
        <View style={{height: 70, justifyContent: 'center'}}>
          <TouchableOpacity
            style={{left: 0}}
            onPress={() => this.props.navigation.replace('Opciones')}>
            <Icon
            ...
            <View
              ...
              <Text
                ...
                <Icon
                  ...
                  size={27}
                  style={{color: color.BLUE, textAlignVertical: 'center'}}
                />
              </Text>
              <Text
                style={{
