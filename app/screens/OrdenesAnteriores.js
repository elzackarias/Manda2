...
export default class OrdenesAnteriores extends Component {
    ...
    async componentDidMount() {
        ...
        try {
            ...
            const fetchResponse = await fetch(GLOBALS.BASE_URL + 'api/api.php?type=consulta&que=ordenes_anteriores', settings);
