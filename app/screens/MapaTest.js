...
export default class MapaTest extends Component {
    _isMounted = false;
    ...
    constructor(props) {
        ...
        this.state = {
            region: {
                ...
                latitude: 17.48864,
                longitude: -99.4583793,
            },
            dataAddress: 'XdXDDKDJDJJDJD',
            isLoading: true,
            referencias: '',
            id_usuario: 0,
            direcciones: []
    ...
    guardarDir = () => {
        ...
        if (referencias.length == 0 || referencias == '' || referencias.length == 5) {
            ...
            fetch('https://70b2-189-202-30-69.ngrok.io/manda2/api/api.php?type=insertar&que=direccion&token=b8d356e2b7134759f486a167583c7e9e', {
                method: 'POST',
                headers: {
                ...
                <View style={{ flex: 1, height: height - 70, backgroundColor: color.WHITE, borderTopRightRadius: 20, borderTopLeftRadius: 20, paddingRight: 20, paddingLeft: 20 }}>
                    <View style={{ width: '100%', height: '35%' }}>
                        <MapView
                            ...
                            <Marker coordinate={{ latitude: this.state.region.latitude, longitude: this.state.region.longitude }} image={require('@recursos/images/bike.png')} />
                        </MapView>
